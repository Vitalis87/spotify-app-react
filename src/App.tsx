...
const App: FC = () => {
  ...
  return (
    <div className="relative flex">
      ...
      {activeSong?.title && (
        <div className="absolute h-28 bottom-0 left-0 right-0 flex animate-slideup bg-gradient-to-br from-white/10 to-[#2a2a80] rounded-t-3xl backdrop-blur-lg z-10">
          <MusicPlayer/>
        </div>
      )}
    </div>
